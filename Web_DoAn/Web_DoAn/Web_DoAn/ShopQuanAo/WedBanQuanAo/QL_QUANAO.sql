...
(
	...
	--KHÓA NGOẠI
	CONSTRAINT FK_TTTK_QUYEN FOREIGN KEY(MAQUYEN) REFERENCES QUYEN(MAQUYEN)
)
...
(
	...
	CONSTRAINT FK_HOADON_TAIKHOAN FOREIGN KEY(TENTK) REFERENCES THONGTINTAIKHOAN(TENTK)
)
...
(
	...
	CONSTRAINT FK_DOITRA_TAIKHOAN FOREIGN KEY(TENTK) REFERENCES THONGTINTAIKHOAN(TENTK)
)
...
--TABLE TAIKHOAN
ALTER TABLE THONGTINTAIKHOAN ADD CONSTRAINT uni_TenLoaiTK UNIQUE(TENTK)
GO
...
--BẢNG THÔNG TIN TÀI KHOẢN
INSERT INTO THONGTINTAIKHOAN VALUES('lethuyna','21122001',N'Lê Thùy Na','17/05/2001',N'Nữ',null,'nalethuy@gmail.com','0362417182',N'Phú Yên',1)
INSERT INTO THONGTINTAIKHOAN VALUES('nguyenngocnhung','21122001',N'Nguyễn Ngọc Nhung','21/10/2001',N'Nữ',null,null,'0368627640',N'Đồng Nai',1)
INSERT INTO THONGTINTAIKHOAN VALUES('vovantin','21122001',N'Võ Văn Tin','21/12/2001',N'Nam',null,null,'0964848973',N'Gia Lai',2)
INSERT INTO THONGTINTAIKHOAN VALUES('trantrongbinhphuong','21122001',N'Trần Trọng Bình Phương','01/01/2001',N'Nam',null,null,'0372645002',N'Đồng Tháp',2)
INSERT INTO THONGTINTAIKHOAN VALUES('dinhphattai','21122001',N'Đinh Phát Tài','30/09/2001',N'Nam',null,null,'0359975249',N'Long An',1)